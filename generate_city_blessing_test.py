...
def build_config():
    ...
    data["report_preview"] = {
        ...
        "reports": {
            "A": {"name": results["A"]["name"], "index_label": "机会放大指数", "base_score": 90, "summary": results["A"]["summary"], "core": "你适合把能力放进高密度市场，用更快的反馈、更专业的协作和更多元的机会，完成一次明显跃迁。", "gold": "旺你的不是城市光环，而是你的能力终于有了回声。", "locked": ["为什么上海适合你｜机会：你的选择显示，你会被竞争、优秀同行和高密度信息激活。上海成熟的行业分工与专业平台，更容易让能力获得清晰反馈。", "为什么上海适合你｜节奏：你能为重要目标承受一段高成本和快节奏，只要看得到成长回报，压力反而会转化为行动力。", "为什么上海适合你｜关系：你不依赖熟人环境，更愿意通过专业能力建立新连接；多元而边界清楚的人际方式，更符合你的独立倾向。", "你的隐藏优势：目标感强、学习快，进入高标准环境后反而更专注，也敢主动争取稀缺机会。", "需要留意：容易用高强度证明价值，把忙碌误认为成长，并低估房租、通勤、孤独与健康的长期成本。", "给你的城市建议：优先选择与你行业高度聚集的区域，准备至少 3—6 个月缓冲金；用收入增长、作品积累和健康状态作为去留指标，不必住在市中心证明自己。", "未来 7 天建议：列出上海能给你的 3 个真实机会，完成月度预算、目标岗位清单和 90 天验证计划。"]},
            "B": {"name": results["B"]["name"], "index_label": "生活滋养指数", "base_score": 88, "summary": results["B"]["summary"], "core": "稳定关系、低消耗日常和真实生活感，会让你的耐心、创造力与长期主义充分发挥。", "gold": "让你松弛下来的地方，才有余地让你慢慢变强。", "locked": ["为什么成都适合你｜生活：你的选择反复指向可控开销、舒适空间和真实日常。成都较强的生活感，能降低你维持生活所消耗的能量。", "为什么成都适合你｜节奏：你更擅长长期积累，而不是持续冲刺。相对松弛的节奏会让你保持耐心，把精力留给真正重要的工作和关系。", "为什么成都适合你｜关系：你重视熟悉感、陪伴与稳定社交。成都开放又有人情味的连接方式，更容易让你建立归属感。", "你的隐藏优势：擅长经营长期关系与稳定日常，能把生活底盘转化为持续创作、工作和成长的力量。", "需要留意：可能把熟悉等同于安全，在舒服里延迟行动，错过本可以低成本尝试的新机会。", "给你的城市建议：把成都当作生活基地，同时建立线上收入、个人品牌或区域服务；选择交通便利但不过度商业化的生活圈。", "未来 7 天建议：盘点本地可利用的 5 项资源，并启动一个不离开当地也能获得新收入或成长反馈的小项目。"]},
            "C": {"name": results["C"]["name"], "index_label": "弹性成长指数", "base_score": 87, "summary": results["C"]["summary"], "core": "你最需要的是选择权：既能连接新产业和新协作，也能保留恢复能量的生活空间。", "gold": "你不必牺牲生活，才能证明自己有野心。", "locked": ["为什么杭州适合你｜机会：你的选择既需要成长，也不愿把生活全部交给竞争。杭州的数字产业、创业协作和灵活工作方式，能提供更轻盈的机会入口。", "为什么杭州适合你｜节奏：你可以适应忙碌，但必须拥有固定恢复空间。城市与自然相连、核心区与周边层次丰富，更方便你调整生活强度。", "为什么杭州适合你｜连接：你擅长线上线下组合，也能跨城市整合资源；杭州与长三角城市的连接，适合你的弹性发展方式。", "你的隐藏优势：整合力强、善于权衡，适合跨城协作、远程工作、主业加副业等组合式成长。", "需要留意：方案越多越容易停在比较阶段，用“再看看”延迟真正的验证。", "给你的城市建议：先确定稳定生活基地，再按固定频率连接行业活动与目标人群；选择能控制通勤、保留自然空间的居住区域。", "未来 7 天建议：完成一份 90 天杭州实验表，写清预算、工作连接、社交频率、生活半径和退出条件。"]},
